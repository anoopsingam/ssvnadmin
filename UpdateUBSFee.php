...
<?php
$sql="SELECT * FROM ubs_fee WHERE id='$dcry'";
...
<form id="form1" name="form1" method="post" action="UbsfeeUpdate">
<div class="row">
<div class="col-sm"><label for="class">Class</label>
<select name="ubs_class" id="" class="form-control">
<option value="<?php echo $row['ubs_class']?>" class="bg-warning text-dark" selected ><?php echo $row['ubs_class']?></option>
...
<div class="col-sm"><label for="fee">Fee</label><input type="number" name="ubs_fee" id="fee" value="<?php echo $row['ubs_fee']?>" class="form-control" /></div>
