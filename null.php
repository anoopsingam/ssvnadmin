...
<b><?php echo "Teacher ID: ".$leave_details['teacher_id']?></b>,<br />
<?php echo $kyt_details['permanent_address']?></p>
<b><p>Date: <?php echo $leave_details['leave_approved_on']?></p></b>
...
Sri Sathya Sai Vidya Niketan, Bagepalli-561207</p>
   ...
   <center>
   <input type="button" id="create_pdf" class="btn btn-danger" value="Generate PDF">
