...
<title>UBS Fee Reports | <?php echo $theader;?></title>
        ...
        $('#example').DataTable({
            ...
            buttons: [

                {
                    ...
                    text: 'Download Excel',
                    title: 'UBS Fee Report <?php echo"$newfrmdate - $newenddate"; ?>',
                ...
                },
                {
                    ...
                    title: '<center><h2><img src="img/logo (2).png" height="60px" width="60px">SRI SATHYA SAI VIDYANIKETAN </h2><h5>UBS Fee Report <?php echo"$newfrmdate - $newenddate"; ?></h5><h6>Developed By- Stark Tech Innovative Labs</h6></center>',
                    text: 'Print ',
